...
class Text2VideoDataset:
    def __init__(
        ...
        # CHANGE has a lot of extra keys coming in. the library provided function runs a lot of extra checks. could be refactored to make it cleaner
        self._train_dataset  = get_video_dataset(
            ...
            crop_size=crop_size,
            keys_to_remove = ['start_frame', 'native_fps', 'original_height', 'pad_masks', 'json', 'fps_id', 'original_width', '__url__']
        )
